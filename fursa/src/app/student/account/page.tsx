...
export default async function StudentAccountPage() {
  ...
  return <main className="page-shell account-profile-content student-account-page">
    ...
    <div className="account-profile-grid">
      <section className="card account-identity"><i>{initials}</i><div><h2>{ctx.user.name}</h2><p>{ctx.student.university || "University not added"}</p><span>Student account</span></div></section>
