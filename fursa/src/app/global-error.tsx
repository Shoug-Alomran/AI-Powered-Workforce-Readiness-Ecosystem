...
export default function GlobalError({
  ...
  return (
    <html lang="en">
      <body style={{ margin: 0, fontFamily: "system-ui, -apple-system, Segoe UI, Arial, sans-serif", background: "#f7faf8", color: "#0b201a" }}>
        <main style={{ minHeight: "100vh", display: "grid", placeItems: "center", padding: "48px 20px" }}>
          <div style={{ maxWidth: 520, textAlign: "center" }}>
            ...
            <p style={{ color: "#53665f", lineHeight: 1.6, margin: "0 0 24px" }}>
              An unexpected error interrupted this page. Your data has not been affected.
            </p>
            <button
              onClick={reset}
              style={{ padding: "12px 20px", borderRadius: 999, border: 0, background: "#0a7765", color: "#fff", fontWeight: 700, fontSize: 15, cursor: "pointer" }}
            >
              Try again
            </button>
          </div>
