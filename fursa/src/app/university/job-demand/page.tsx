...
export default async function UniversityJobDemand({ searchParams }: { searchParams: Promise<{ q?: string; track?: string }> }) {
  ...
  return <main className="page-shell">
    ...
    <p className="muted">Every signal below comes from an open employer role in Fursa. Use it to decide which modules, practical experiences, and certifications should enter curriculum review.</p>
