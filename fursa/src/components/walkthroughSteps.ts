  ...
  // ------------------------------------------------------------- UNIVERSITY
  {
    ...
    tour: {
      ...
      steps: [
        ...
        { title: "Curriculum alignment", body: "Where your offerings meet demand, and where the gap is widening.", selector: ".ud-alignment, .ud-alignment-stats" },
        { title: "Graduate outcomes", body: "Placement and readiness outcomes aggregated across your students.", selector: ".ud-outcomes" },
        ...
        { title: "Forecast and advice", body: "Projections are advisory inputs to a human decision, not automated policy.", selector: ".ud-forecast, .ud-advisor" },
      ],
    },
  },
  {
