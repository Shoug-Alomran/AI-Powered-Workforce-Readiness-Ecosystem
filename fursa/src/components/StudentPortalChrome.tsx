...
export default function StudentPortalChrome({ name }: Props) {
  ...
  return <header className="student-template-topnav">
    <div className="student-template-topbrand"><span>F</span><b>FURSA</b></div>
    ...
    <div className="student-template-topuser"><button aria-label="Notifications">{icons.bell}</button><Link href="/student/account"><span><b>{name}</b><small>Student profile</small></span><AccountAvatar initials={initials}/></Link></div>
  </header>;
}
