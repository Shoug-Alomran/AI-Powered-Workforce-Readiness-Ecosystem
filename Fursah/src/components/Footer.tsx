...
export default async function Footer(){
  ...
  return <footer className="site-footer"><div className="site-footer-grid">
    ...
    <section><h2>{user?"Your Workspace":"Platform"}</h2>{accountLinks?accountLinks.map(([label,href])=><Link href={href} key={href}>{label}</Link>):<><Link href="/#how-it-works">How it Works</Link><Link href="/#ai-ethics">Explainable AI</Link><Link href="/#solutions">Skill Mapping</Link><Link href="/workforce-intelligence">Workforce Intelligence</Link><Link href="/impact">National Impact</Link><Link href="/standards">Standards Conformance</Link><Link href="/knowledge-base">Knowledge Base</Link><Link href="/team">Our Team</Link></>}</section>
    ...
    <section><h2>Company</h2><Link href="/policies/privacy">Privacy Policy</Link><Link href="/policies/terms">Terms of Service</Link><Link href="/policies/responsible-ai">Responsible AI</Link><Link href="/policies/accessibility">Accessibility</Link><a href="/fursah-ai-readiness-hackathon-submission.pdf" target="_blank" rel="noopener noreferrer">AI Readiness Report (PDF)</a><a href="/fursah-business-analysis.pdf" target="_blank" rel="noopener noreferrer">Business Analysis (PDF)</a></section>
    <section><h2>Contact</h2><a href="mailto:info@fursah.org">info@fursah.org</a><a href="tel:+966110000000">+966 53 100 7472</a><p>Riyadh, Saudi Arabia</p></section>
