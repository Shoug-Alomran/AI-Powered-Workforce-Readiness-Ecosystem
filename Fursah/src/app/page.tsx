...
function BriefcaseIcon(){return <svg viewBox="0 0 24 24" aria-hidden="true"><rect x="3" y="7" width="18" height="13" rx="2"/><path d="M8 7V5.5A1.5 1.5 0 0 1 9.5 4h5A1.5 1.5 0 0 1 16 5.5V7M3 12h18M10 11v2h4v-2"/></svg>}
function ReportIcon(){return <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M6 3h8l4 4v14H6z"/><path d="M14 3v5h5M9 12h6M9 16h6"/></svg>}
...
export default async function Home(){const [students,jobs,employers]=await getHomeCounts();const metrics=[[students,"Illustrative student records"],[jobs,"Illustrative opportunities"],[employers,"Illustrative employers"],[allSkillNames().length,"Skills in shared taxonomy"]] as const;return <main className="home-design">
  <SiteHeader onHome />
  <section className="home-hero"><div><Link href="/impact" className="home-vision">●　BUILT FOR SAUDI WORKFORCE READINESS</Link><h1><span>Turn verified student evidence into </span><em>workforce-ready talent.</em></h1><p>Fursah helps students prove readiness. Employers can identify qualified applicants, and universities can address curriculum gaps. Every result links to inspectable evidence.</p><div className="home-ctas"><Link href="/login/demo">Choose your workspace</Link><a href="#how-it-works" className="secondary">See how evidence flows</a>{DEMO_VIDEO_URL ? <Link className="home-video-cta" href="/judge-demo#demo-video"><span aria-hidden="true">▶</span> Demo video <small>7 min</small></Link> : <button className="home-video-cta" type="button" disabled title="Demo video coming soon"><span aria-hidden="true">▶</span> Demo video <small>Coming soon</small></button>}</div><p className="home-hero-proof">Deterministic scoring · Grounded AI explanations · Human decisions</p></div><div className="home-preview"><header><i/><i/><i/><small>STUDENT CAREER HUB</small><span/></header><div className="home-preview-body"><section className="home-score"><div><small>Career Readiness Score</small><b>84%</b></div><i><em/></i></section><div className="home-preview-grid"><article><small>VERIFIED SKILLS</small><p><span>Python</span><span>Data Analysis</span></p></article><article><small>NEXT ACTION</small><p><span>Evidence public speaking</span></p></article></div><section className="home-opportunity"><small>RECOMMENDED OPPORTUNITY</small><div><i><BriefcaseIcon/></i><span><b>AI Research Intern</b><small>Aramco • Dhahran</small></span><em><b>5/6 requirements</b><small>Evidence-linked</small></em></div></section></div></div></section>
  ...
  <section id="ai-ethics" className="home-section home-ethics"><div><h2>Explainable AI as a Foundation for Trust</h2><p>Fursah provides a reasoning card for each recommendation. The card explains the evidence and rules behind the result.</p><ul><li>✓　Gender, nationality, age and GPA are not collected. They cannot affect a score.</li><li>✓　Scoring weights are published and inspectable</li><li>✓　Each decision records its ruleset version and reasoning</li></ul><a className="home-ethics-doc" href="/fursah-ai-readiness-hackathon-submission.pdf" target="_blank" rel="noopener noreferrer"><ReportIcon/><span>Read the AI Readiness Report (PDF)</span></a></div><article><header><b>AI RECOMMENDATION LOGIC</b><span>Confidence: 94%</span></header><div className="home-candidate"><i>S.A.</i><span><b>Sara Al-Otaibi</b><small>Candidate ID: #88219</small></span></div><section><b>Why this match?</b><p>The candidate demonstrated advanced problem solving in CS401 and reached the 98th percentile in the 2024 Coding Olympiad.</p></section><section className="violet"><b>Skill Alignment</b><p><em>Full-Stack Engineering</em> <span>High</span></p><i><em/></i></section></article></section>
