...
export default function CommercialReadinessPage() {
  return <main className="imp commercial-readiness"><SiteHeader/><div className="imp-shell">
    <section className="imp-hero"><span className="imp-eyebrow">Controlled adoption</span><h1 className="imp-title">A credible first purchase, not a market-size promise.</h1><p className="imp-lead">Fursah’s first commercial wedge is a university career-readiness office seeking evidence-based cohort plans and better alignment with employer requirements. Pricing and outcome claims remain deliberately unasserted until a controlled pilot produces evidence.</p><div className="judge-actions"><Link href="/support">Discuss a pilot</Link><Link className="secondary" href="/judge-demo">Inspect the product</Link></div></section>
